...
const BUDGETS = {
  core: { file: 'dist/index.js', budget: 5 },
  tokens: { file: 'dist/index.js', budget: 5 },
  network: { file: 'dist/index.js', budget: 5 },
  ...
  runtime: { file: 'dist/index.js', budget: 25 },
  observability: { file: 'dist/index.js', budget: 15 },
  contracts: { file: 'dist/index.js', budget: 5 },
  migration: { file: 'dist/index.js', budget: 8 },
  testing: { file: 'dist/index.js', budget: 10 },
  cli: { file: 'dist/cli.js', budget: 50 },
  devtools: { file: 'dist/index.js', budget: 15 },
