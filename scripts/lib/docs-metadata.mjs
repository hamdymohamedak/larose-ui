...
export const PLAYGROUND_CONTROLS = {
  ...
  LiquidGlassButton: {
    children: { control: 'text', default: 'Continue', label: 'Label' },
    disabled: { control: 'boolean', default: false },
  },
  LiquidGlassSwitch: {
    defaultChecked: { control: 'boolean', default: false },
    disabled: { control: 'boolean', default: false },
  },
  LiquidGlassProgress: {
    value: { control: 'number', default: 62, min: 0, max: 100 },
    indeterminate: { control: 'boolean', default: false },
  },
  LiquidGlassRange: {
    defaultValue: { control: 'number', default: 50, min: 0, max: 100 },
    disabled: { control: 'boolean', default: false },
  },
  LiquidGlassCheckbox: {
    label: { control: 'text', default: 'Enable liquid glass' },
    defaultChecked: { control: 'boolean', default: true },
    disabled: { control: 'boolean', default: false },
  },
  Spinner: {
...
export const COMPONENT_ANATOMY = {
  Modal: {
    ...
    structure: ['Modal (root portal)', 'Overlay', 'Content', 'Title', 'Description', 'Body (default slot)'],
    ...
    slots: ['default'],
    states: ['closed', 'open', 'entering', 'exiting'],
  },
  Drawer: {
    summary: 'Drawer slides in from the left or right edge with overlay dismissal.',
    structure: ['Drawer (root)', 'Overlay', 'Panel', 'Header', 'Body (default slot)'],
  ...
  LiquidGlass: {
    ...
    structure: ['LiquidGlass shell', 'Specular rim', 'Inner highlight', 'Content wrapper'],
  ...
  LiquidGlassRange: {
    ...
    structure: ['Glass track', 'Fill', 'Glass thumb', 'Native range input (a11y)'],
  ...
  LiquidGlassProgress: {
    ...
    structure: ['Glass track', 'Fill bar'],
  ...
  LiquidGlassCheckbox: {
    ...
    structure: ['Glass box', 'Check icon', 'Label'],
  ...
  Tabs: {
    ...
    structure: ['Tabs', 'TabsList', 'TabsTrigger', 'TabsPanel'],
  ...
  TabView: {
    ...
    structure: ['TabView', 'TabViewList', 'TabViewTab', 'TabViewPanel'],
  ...
  Accordion: {
    ...
    structure: ['Accordion', 'AccordionItem', 'AccordionTrigger', 'AccordionContent'],
