...
> Authorization-aware Svelte UI (RBAC / ABAC).
...
```bash
npm install @larose-ui/permissions-svelte
# or
pnpm add @larose-ui/permissions-svelte
# or
yarn add @larose-ui/permissions-svelte
```
