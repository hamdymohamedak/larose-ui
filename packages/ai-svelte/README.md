...
> Permission-bound AI UI for Svelte (SmartTable / SmartForm).
...
```bash
npm install @larose-ui/ai-svelte
# or
pnpm add @larose-ui/ai-svelte
# or
yarn add @larose-ui/ai-svelte
```
...
```tsx
import { AIProvider, SmartTable } from '@larose-ui/ai-svelte';
```
