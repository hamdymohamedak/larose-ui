...
export const DEPRECATIONS: Deprecation[] = [
  {
    ...
    replacement: 'Use <Can permission="..."> from @larose/permissions',
    removedIn: '1.0.0',
  },
  {
    id: 'old-token',
    ...
    replacement: 'Use --lr-color-* tokens from @larose/tokens',
    removedIn: '1.0.0',
  },
  {
    id: 'react-provider',
    pattern: /from\s+['"]@larose\/react['"].*LaRoseProvider/g,
    message: 'Import LaRoseProvider from @larose/runtime instead',
