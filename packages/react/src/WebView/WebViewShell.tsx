 ...
 */
export function WebViewShell({ navigation, footer, className, style, ...webViewProps }: WebViewShellProps) {
  return (
    <div className={[styles.shell, className].filter(Boolean).join(' ')} style={style}>
